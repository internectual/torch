...
void Game::render(float dt) {
    ...
    if (shapeViewerActive && shapeViewerShape.loaded) {
        ...
        // TODO: renderAnimation produces wrong transforms — shapes look correct via render()
        // Disable animation rendering in shape viewer until the transform math is debugged
