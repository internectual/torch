...
bool T2Protocol::decodeDatablock(const uint8_t* data, size_t size,
                                  DatablockHeader& hdr,
                                  const uint8_t*& payload, size_t& payloadLen) {
...
size_t T2Protocol::encodeGhostHeader(uint8_t* buf, size_t bufSize, const GhostMessage& msg) {
    // Format: [GDT_Ghost/GDT_GhostAlways][index:4][type:1][classId:4]
...
bool T2Protocol::decodeGhostHeader(const uint8_t* data, size_t size, GhostMessage& msg) {
...
size_t T2Protocol::encodeGameState(uint8_t* buf, size_t bufSize, const GameStateMessage& msg) {
...
bool T2Protocol::decodeGameState(const uint8_t* data, size_t size, GameStateMessage& msg) {
...
bool T2Protocol::decodeChat(const uint8_t* data, size_t size, ChatMessage& msg) {
    ...
    // Clamp to destination buffer size BEFORE any copy (attacker-controlled length).
